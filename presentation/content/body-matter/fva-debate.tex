        ...
        \begin{enumerate}
            ...
            \item Theoreticians argue that a project's riskiness should determine the discount rate.
                \note[item]{
                    ...
                    not the institution's funding rate.
                    They argue that using FVAs break the assumptions of traditional valuation frameworks.
                    The valuation of derivatives will deviate from being market based,
                    and instead based on specific entities.
                }
                \vspace{.5cm}
                \begin{center}
                    \resizebox{5cm}{!}{%
