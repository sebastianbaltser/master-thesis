...
\begin{document}
    ...
    \begin{frame}
        ...
        \note[item]<1>{
            ...
            and it considers obtaining a project yielding a payoff.
            This figure can to some extent most of the analysis we did.
        }
        \note[item]<1>{
        ...
        \note<2>{
            ...
            \begin{enumerate}
                \item Under debt funding, the new creditors charges a credit spread.
                      Shareholders pays this credit spread when the firm does not default,
                ...
                \item Under equity funding, the required return from the new shareholders
                      ...
                      hence they must have a higher payoff in the no-default state.
                \item Under cash funding, there is not financing cost, 
                      since the firm "borrows" from its balance sheet at the risk-free rate.
                      When the project payoff is positively correlated to the no-default event,
                      the project essentially moves asset value 
                      from the default state no-default state. 
                      The shareholder ends up with a higher payoff in the no-default state.
            \end{enumerate}
        }
        \note<3>{
            A couple of results can be derived from this.
            \begin{enumerate}
                \item \textit{The pecking order theory:}
                      ...
                      they require a higher return than new creditors. 
                ...
                \item \textit{The Free Rider Problem:}
                      ...
                      This is why Hull \& White's example does not work in reality.
                ...
                \item \textit{The use of FVAs:}
                      ...
                      the wealth of its shareholders are preserved,
                      as an FVA takes into account the funding costs that the shareholders incur.
        ...
        \note<4>{
            ...
            \begin{enumerate}
                ...
                \item How the projects payoff is structured. 
                      ...
                      that is paid out when the firm defaults. 
            \end{enumerate}
        }
    \end{frame}
