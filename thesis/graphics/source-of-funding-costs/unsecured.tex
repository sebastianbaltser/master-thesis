...
\draw[->, thick] 
    ...
    node[near start, fill=white, inner sep=0pt] {
        \includegraphics[width=0.75cm]{\graphicsfolder/source-of-funding-costs/contract.png}
    };
\draw[<-, thick] 
...
\draw[<->, thick, draw=blue] 
    ...
    node [pos=0.4, fill=white, inner sep=0pt] {
        \includegraphics[width=0.85cm]{\graphicsfolder/source-of-funding-costs/collateral.png}
    };
\draw[<->, thick, draw=red] 
