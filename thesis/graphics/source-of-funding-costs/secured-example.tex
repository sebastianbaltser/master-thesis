...
\node [draw, thick] (funding-institution-1) at ([yshift=\fundingyshift cm] funding1-in.east) {Prime broker};
...
\node [draw, thick] (funding-institution-2) at ([yshift=\fundingyshift cm] funding2-out.east) {Prime broker};
\draw [->, draw=fundingcolor, thick] 
