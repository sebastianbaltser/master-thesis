...
\node [draw, thick] (funding-institution-1) at ([yshift=\fundingyshift cm] funding1) {Prime broker};
...
\node [draw, thick] (funding-institution-2) at ([yshift=\fundingyshift cm] funding2) {Prime broker};
\draw [->, draw=fundingcolor, thick] 
