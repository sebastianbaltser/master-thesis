...
\begin{document}
    ...
    \subsubsection{Funding by debt issuance}
        ...
        for the possibility that the bank might default. 
        If the bank defaults, this amount is not to be paid and the \FVA/ is therefore, in addition, 
        equal to the expected benefit to the bank from defaulting, also known as the DVA. 
