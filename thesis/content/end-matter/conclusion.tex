...
\begin{document}
    ...
    as shareholders pays the funding costs of financing the project,
    but does not enjoy the benefits from the project.
    Those benefits are instead enjoyed by the firm's creditors.

    If the firm does not apply \FVA/s the shareholders are subject to a loss
    corresponding to the funding costs of the project.
    The size of this loss is greatly influenced by the financing method chosen by the firm,
