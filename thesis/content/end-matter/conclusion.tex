...
\begin{document}
    ...
    the thesis were able to study how stakeholders were affected by a firm obtaining a new project.
    The new project created different incentives for shareholders, creditors and the firm in general.
    The project needed financing, 
    and the analysis showed that the funding costs 
    of obtaining the project was borne by the shareholders.
    The welfare lost by shareholders was transferred to the legacy creditor.
    Hence, obtaining the project would result in a free-rider problem, 
    as shareholders paid the funding costs of financing the project,
    but did not enjoy the benefits from the project.
    Those benefits were instead enjoyed by the firm's creditors.

    If the firm did not apply \FVA/s the shareholders were subject to a loss
    corresponding to the funding costs of the project.
    The size of this loss was greatly influenced by the financing method chosen by the firm,
    due to the derived pecking order of financing choices.

    Applying an \FVA/ to the valuation of a project was a way for the firm 
