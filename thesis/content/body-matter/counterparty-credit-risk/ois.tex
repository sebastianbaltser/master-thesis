...
\begin{document}
    ...
    Before the financial crisis in 2008, banks had typically been discounting
    ...
    \Cref{fig:ted-spread} shows the TED spread instead of the LIBOR-\OIS/,
    ...
    \Cref{fig:ted-spread} supports the conclusion from the previous section
    ...
    argue that this second risk is negligible in collateralised transactions,
