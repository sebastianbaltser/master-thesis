...
\begin{document}
    ...
    \cite[Section 8.6]{Green2015XVA} mentions two possible reasons for banks using these indices.
    ...
    \cite[HW] argues that this second risk is negligible in collateralized transactions,
