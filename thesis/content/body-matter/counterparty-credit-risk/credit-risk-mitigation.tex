...
\begin{document}
    ...
    the amount of counterparty risk a dealer is willing to take on 
    is given by the default risk of the counterparty as well as the dealer's risk appetite.
    When this limit is set, the dealer will be able to obtain some amount of trades,
    before the risk limit is met.
    If the dealer is to cleverly apply credit risk mitigations,
    she might be able to obtain an even larger amount of trades,
    increasing her capacity to do business.
    If the dealer applies credit risk mitigations but does not increase her holdings, 
    ...
    \subsection{Clearing Through Central Counterparty}
        ...
        Hence, throughout the thesis, CSA agreements will be mentioned the most,
