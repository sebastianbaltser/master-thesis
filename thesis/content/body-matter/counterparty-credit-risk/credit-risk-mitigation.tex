...
\begin{document}
    ...
    Reducing credit risk to a counterparty has important implications.
    ...
    increasing the its capacity to do business.
    If the firm does not apply credit risk mitigations but neither increases its holdings, 
    its capital requirements might instead be reduced. 
    ...
    \subsubsection{Netting}
        ...
        Netting sets are important to credit exposure, as counterparty risk is settled at them;
        therefore, netting is central to mitigating credit risk.
        To see this, consider the following examples.

        A derivatives dealer has two different netting sets, netting set X and netting set Y.
        The dealer sells a derivative with netting set X
        and, not wanting the exposure, it buys the same derivative with netting set Y.
