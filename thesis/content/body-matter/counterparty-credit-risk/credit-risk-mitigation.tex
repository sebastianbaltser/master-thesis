...
\begin{document}
    ...
    Credit risk mitigation is actions taken by firms with the purpose of reducing their credit risk.
    ...
    \subsubsection{Collateralization}
        ...
        Trades can use repos to apply leverage by buying long positions in securities 
        ...
        A CSA defines terms and conditions that allows the posting of collateral 
        between counterparties in order to secure a transaction made between them.
        Most CSA agreements requires both entities in the transaction to post collateral if
        they have negative exposure to their counterparty. 
        This is important in derivatives transactions that can have both 
        ...
        This mechanism will prove to be very important when in the context of funding value adjustments,
        ...
        \begin{description}
            ...
            but, like a threshold, it comes at the cost of increased exposure.
            ...
            The counterparty posting an independent amount decreases the exposure
        ...
        i.e. which currencies can be used or if government bonds can be used as collateral,
        as well as a procedure to follow if one of the parties is downgraded to a specified credit rating.
        It must be emphasized that the parameters might not be identical for each party,
