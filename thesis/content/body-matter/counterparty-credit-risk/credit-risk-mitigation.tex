...
\begin{document}
    ...
    \subsection{Netting}
        ...
        By strategically considering netting benefits the dealer can reduce its credit risk. 
        Additionally, the dealer can further reduce its exposure by, in advance,
        taking custody of some of its receivables from the counterparty.
