...
\begin{document}
    ...
    \subsubsection{Central clearing}
        A Central Counterparty Clearing House, CCP, is an entity 
        ...
        While there are important differences between central clearing and CSA agreements,
        this paper will not explicitly treat them differently.
        As they are very similar from from a collateralization point of view,
        it will, for the purposes in this thesis,
        not make much difference whether a particular pair of counterparties uses one or the other.
        Hence, variation margin will be used interchangeably with collateral posting
        and initial margin with independent amount.
