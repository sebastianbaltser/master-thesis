...
\begin{document}
    ...
    \subsection{Netting}
        ...
        offsetting payables with receivables, such that, in the liquidation of a counterparty,
        ...
        However, the credit risk exposure metric for the entire dealer will include 
        the credit risk metric for both netting set X and Y.
