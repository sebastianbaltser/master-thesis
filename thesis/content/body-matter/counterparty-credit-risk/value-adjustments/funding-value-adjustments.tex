...
\begin{document}
    \subsubsection{Funding Value Adjustments}
        ...
        By considering its financing costs when valuing the Treasury bills, 
        the dealer has made an \FVA/.
        By adjusting its valuation of the asset, 
        the dealer is trying to align its shareholders' interests with its market operations.
