...
\begin{document}
    \subsection{Credit Value Adjustments}
        ...
        the discount offered by the BBB rated bank, relative to the AAA rated bank, is exactly the value that the dealer
        ...
        i.e. the discount offered by the BBB rated bank to make the dealer indifferent, is the \CVA/.
