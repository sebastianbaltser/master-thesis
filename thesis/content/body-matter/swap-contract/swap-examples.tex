...
\begin{document}
    ...
    \label{sec:swap-examples}
        ...
        $\phi=(L_{2}-(\mathscr{d}^{2}A_{0}-W))/L_{2}=\pct{0.114143}$,
        and the credit spread is then given by:
        $(\phi*p_{\mathscr{d},\mathscr{d}}R_{1})/(1-\phi p_{\mathscr{d},\mathscr{d}}) = \pct{0.0114975}$.
