...
\begin{document}
    ...
    $A_0 = 100$ &               & $\mathscr{u}\mathscr{d}A_{0}=93.5$ \\
        ...
        \subsection{Example of unsecured swap}
            ...
            in this case, some cash flows matured in the future and were random.
            To account for them, the dealer had to estimate their size 
            by using their expected value.
            ...
            the firm could obtain funding at a very low credit spread of \pct{0}.
            ...
            The firm have a large face value maturing at time 2, 
