    ...
    $A_0 = 100$ &               & $\mathscr{u}\mathscr{d}A_{0}=93.5$ \\
       ...
       which allows for the theory discussed in \cref{sec:secured-swap-valuation} to be applied.
        ...
        \subsection{Example of unsecured swap}
            ...
            On the other hand, the dealer's cash flow at the interim date is positive,
        ...
        \subsection{Example of secured hedging swap}
            ...
            i.e. the two swap parties enter a CSA agreement.
            I addition to marking to market at each time period,
            an independent amount has to be posted.
            This amount will be referred to as the initial margin.
            Similar to the single-period model,
            the initial margin is assumed to be 50\% of the price  of the secured swap,
