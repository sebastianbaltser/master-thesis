    ...
    $A_0 = 100$ &               & $\mathscr{u}\mathscr{d}A_{0}=93.5$ \\
       ...
       which allows for the theory discussed in \cref{sec:secured-swap-valuation} to be applied.
        ...
        \subsection{Example of secured hedging swap}
            ...
            \\
            By solving, a swap price of $u=\num{0.14032192327080525}$ is obtained.
            ...
            The new loss rate is computed as $\phi = \pct{0.1140257490725447}$.
            ...
            \begin{equation}
                G_{\text{swap,hedged}} = \num{0.0146616}
            \end{equation}
            suggesting a positive net present value investment for the shareholders. 
            ...
            meaning they would pay more than the original swap price.
