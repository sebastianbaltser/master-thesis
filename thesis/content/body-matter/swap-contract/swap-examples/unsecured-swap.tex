...
\begin{document}
    \subsection{Example of unsecured swap}
        ...
        lead to funding shortfalls and surpluses.
        ...
        Hence, the dealer would likely have to provide funding 
        for the differences in upfront payments.
        Of course, practically speaking, the dealer would actually have to provide funding
