...
\begin{document}
    ...
    \label{sec:unsecured-swap-valuation}
        ...
        \\
        It is also assumed that there are no legacy positions between the dealer and the swap client.
        This assumption ensures that the dealer does not take advantage of any netting effects
        such that the cash flows cannot be offset with those of the legacy position.
        ...
        As a consequence, both the dealer and the counterparty have a possibility to lose an otherwise promised income.
        ...
        A perfect CSA agreement would require the dealer to mark-to-market at each time period,
        ...
        which would potentially leave the dealer with more financial obligations.
