...
\begin{document}
    \subsection{Valuing unsecured swaps}
        ...
        \\
        The addend $u S_0 S_1$ appears when expanding the limiting face value, $D_2$.
        From the expressions of the credit spreads, it is noticed that the expectation the loss rates from the different time periods are multiplied.
        The following property of expectations can then be used:
        \begin{equation*}
        ...
        By dividing $q$ into the expectation of the first limit, it can be recognized that $U(q)/q$ is the marginal investment cost, $u$.
        ...
        To find the value of the swap contract that makes the shareholders indifferent of entering the project, $u^{*}$,
