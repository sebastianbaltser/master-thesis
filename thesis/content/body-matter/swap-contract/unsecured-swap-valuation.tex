...
\begin{document}
    \subsection{Valuing unsecured swaps}
        ...
        the face value of the new debt is the upfront, which is the borrowed amount, including the interest rates paid. The marginal increase in the value of the firm's equity per unit investment is therefore:
        \begin{equation}
            G_{\text{debt}} =
