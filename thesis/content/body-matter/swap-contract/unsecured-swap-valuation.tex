...
\begin{document}
    ...
    \label{sec:unsecured-swap-valuation}
        ...
        the \DVA/ is the second term in \cref{eqn:swap-value-multi-period} describing the lost amount of the outstanding liability related to the swap in case of the firm's default.
        ...
        In the multi-period framework, it is assumed that the firm always use debt funding for financing financial instruments.
