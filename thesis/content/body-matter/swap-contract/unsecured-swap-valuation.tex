    ...
    \label{sec:unsecured-swap-valuation}
        ...
        \begin{equation*}
            ...
            * \mathbb{E}_{1}^{\rnmeasure}\left[\phi_2\right]
            ...
            = 0
        \end{equation*}
        where the last equality uses that the loss rate must be zero in at least one of the two periods.
        ...
        The cash flows would in this expanded setup offset each other,
