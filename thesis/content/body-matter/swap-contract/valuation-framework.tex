...
\begin{document}
    \subsection{The Multi-Period Model}
        ...
        \end{align*}
        At time 1, the payoff of everything, but the short term liabilities, are uncertain,
        ...
        one for the excess yield from time 0 to time 1,
        and another for the excess yield from time 1 to time 2.
        ...
        the limiting spread for each period can be derived.
        \\
        At time 0 the limiting spread to time 1 is:
        \begin{equation*}
            S_0 =
            \frac{
        ...
        \end{equation*}
        where $\phi_{1}$ is the creditors' loss rate at time 1,
        ...
        the limiting spread from the interim date to the maturity date is:
        \begin{equation*}
            S_1 =
            \frac{
        ...
        \end{equation*}
        where $\phi_{2}$ is the creditors' loss rate at time 2, given by:
        \begin{align*}
            \phi_2 
            &=
        ...
        For the purposes of this paper, not much would be gained, besides complexity.
        Therefore, no effort will be funnelled in this direction,
