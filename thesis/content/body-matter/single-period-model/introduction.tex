...
\begin{document}
    ...
    and their implications to a financial institutions's stakeholders, 
    ...
    an up-state where the value of the assets are high,
    ...
    and the project can have other important features such as collateralisation requirements.
