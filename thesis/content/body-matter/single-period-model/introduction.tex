...
\begin{document}
    ...
    A financial institution financed by debt and equity operates in a single-period binomial tree.
    In the next time period, two possible states can have realized;
