...
\begin{document}
    \subsection{Marginal valuation of corporate assets and liabilities}
        ...
        The analysis is therefore extended to consider a swap position that includes both secured as well as unsecured components.
        ...
        Then the cash flows of the firm where the swap position 
        ...
        \begin{equation}
            \mathcal{C} =
                ...
                - \mathbbm{1}_{\mathcal{D}(q)} \kappa (A + qY_{1}) \rho
        \end{equation}
