...
\begin{document}
    ...
    \label{sec:defining-fva}
        ...
        The definitions are due to \textcite{Hillion2016}.
        ...
        \subsubsection*{FVA as the promised excess funding cost}
            ...
            is shown by \textcite{HullWhiteFVA}.
        ...
        \subsubsection*{FVA as the adjustment to shareholders' breakeven}
            ...
            and solving for the marginal investment cost:
                ...
                \end{align}
            A result named Proposition 3 by \textcite{ADS2019}.
        ...
        Referring to the \FVA/ as \textit{the donation} needed from the counterparty,
        might be off-putting at first, 
        as derivative dealers and hedge funds are seldom perceived as being charitable organizations.
        ...
        Therefore, it would be necessary to explain the counterparty's motives for doing so.
        To do so, it will be helpful to recall \cref{sec:price-versus-value},
        ...
        but in reality derivatives trade at a price set by the market.
        ...
        arises when the counterparty itself have a relatively high funding cost.
        ...
        The dealer will have to fund the upfront price, for which it pays its funding rate,
        and it is going to take this funding cost into consideration when valuing the derivative.
        ...
        all else being equal, it is going to adjust its valuation upwards more 
        than the dealer adjusts its valuation downwards. 
        If the two funding rates are sufficiently different, 
        the counterparty will be able to offer price a to the dealer,
        ...
        Its simply driven by the fact that different organizations 
        ...
        An organizations particular motive for raising or reducing prices
        is not of interest in this paper and will be left unspecified.
        These examples above are merely a justification for using the term \textit{donation},
