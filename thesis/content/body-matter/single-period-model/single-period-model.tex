...
\begin{document}
    ...
    \subsection{The Single-Period Model}
        ...
        At time 1 the economy can materialise in one of $N$ possible states, $\omega_{1}, \dots, \omega_{N}$, and each state occurs with a strictly positive probability.
    ...
    \subsection{Firm Capital Structure}
        ...
        In a default event, the firm can suffer distress costs, e.g. due to liquidation of its assets.
        ...
        Shareholders receive the remainder of the firm's value after the debt has been paid;
