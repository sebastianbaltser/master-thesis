...
\begin{document}
    \subsection{Funding Secured Derivatives}
        ...
        The collateral posted is a variation margin that in this case covers the entire amount of the derivative payable.
        ...
        The \MVA/ determines the difference between the market value and value that makes the shareholders indifferent to entering the new secured project.
        ...
        As can be seen on \cref{tbl:example-collateralized-derivative}, the payoff of the legacy creditors at the default event is higher than the pre-project value, while the payoff of the shareholders in the events of no default has decreased.
        As the project is a zero net present value investment for the new creditors, there must be a wealth transfer from the legacy creditors to the shareholders.
