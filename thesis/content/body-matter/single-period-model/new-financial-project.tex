...
\begin{document}
    \subsection{Obtaining a New Financial Project}
        ...
        depending on the state realised a time 1, 
        ...
        The positive part of the payoff, $Y^{+}=\max\left(Y,0\right)$, is perceived as an asset of the firm, and is measured net of any potential losses due to firm's counterparty credit risk.
        ...
        For this motive, the payoff is divided in two, such that $Y=Y_1 + Y_2$,
        where $Y_{1}$ is the secured component and $Y_{2}$ is the unsecured component.
        Then, $Y_1^{-}$ reflects the secured contingent liability, 
        and $Y_2^{-}$ reflects the unsecured contingent liability.
        The financial position is still assumed to pay a payoff, $Y$, at time 1 which is unrelated to the credit risk of the firm,
        and the unsecured contingent liability is still assumed to rank pari passu with all other unsecured creditor claims.\\
