...
\begin{document}
    ...
    \label{sec:example-funding-benefit}
        ...
        \subsubsection{Retiring Legacy Debt}
            ...
            The bond's payable is now a liability to the firm, 
        ...
        \subsubsection{Buying Back Equity}
            ...
            and bond's payable is the same after the transaction. 
            ...
            therefore, the loss rate on the debt and the bond's payable remains unchanged,
        ...
        \subsection{No Funding Buyback}
            ...
            At time 1 the firm will pay the counterparty accordingly, hence the derivative's payable, 
            ...
            where in state $\omega_4$, the derivative's payable is less than the return on the risk-free asset.
            ...
            As the firm is funding the risk-free project with the premium proceeds, no funding benefits actually occur, and the \FVA/ is constituted entirely by the funding costs from paying the derivative's payable.
