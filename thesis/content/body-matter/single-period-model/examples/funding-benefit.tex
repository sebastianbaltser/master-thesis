...
\begin{document}
    ...
    \label{sec:example-funding-benefit}
        ...
        \subsubsection{Debt retiring}
            ...
            the firm now enters a bond by selling a project to a counterparty
            ...
            which before the bond had a face value of \num{80}. 
            For simplicity, it is assumed, as in \cref{sec:risk-free-project},
            that the bond payable is known with certainty, hence it is a risk-free project. 
            The firm's balance sheet is not affected by the transaction. 
