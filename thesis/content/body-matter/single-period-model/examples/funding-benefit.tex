...
\begin{document}
    ...
    \label{sec:example-funding-benefit}
        ...
        \subsubsection{No funding buyback}
            ...
            Furthermore, the condition of no wealth transfer away from the shareholders, \cref{eqn:no-wealth-transfer-no-funding-buyback}, is added to the equation system.
