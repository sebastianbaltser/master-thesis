...
\begin{document}
    ...
    \label{sec:example-funding-benefit}
        ...
        Suppose the firm sells the simple derivative in \cref{tbl:single-period-simple-derivative-payoff} to the counterparty. 
        ...
        \subsubsection{Equity buyback}
            ...
            Is assumed that the firm receives the credit risk adjusted market price, i.e. $u=0.959$ as the derivative premium at time 0, which is immediately spend on equity buyback. 
