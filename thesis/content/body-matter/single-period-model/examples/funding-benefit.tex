...
\begin{document}
    ...
    \label{sec:example-funding-benefit}
        ...
        If the firm defaults before or at the bond's expiry, the firm will not be able to meet the obligations, 
        and the potential profit from the unsecured bond contract will not be fully paid out. 
        ...
        For simplicity, it is assumed that the bond contract 
