...
\begin{document}
    ...
    \label{sec:example-funding-benefit}
        ...
        \subsubsection{No funding buyback}
            ...
            as buying a derivative and funding the upfront price with existing cash.
            ...
            \begin{equation}
                G_{\text{cash}} = -\discountfactor \text{Cov}^{\rnmeasure}\left(\mathbbm{1}_{\mathcal{D}},Y_{C}\right) = \num{-0.188534}
            \end{equation}

            The change in wealth for the creditors can be verified by the difference between the new present value of the debt and the old present value of the debt:
            \begin{equation}
                \Delta \pi(D) = \num{76.988534} - \num{76.8} = \num{0.188534}
            \end{equation}
            ...
            The change in wealth for the shareholders is similarly verified by:
            \begin{equation}
                \Delta \pi(S) = \num{19.411469} - \num{19.6} = \num{-0.188531}
            \end{equation}
            ...
            \\
            The valuation adjustment suggests a higher derivative premium than the market value. Specifically, the premium paid by the counterparty would be $u^{\ast}$.
            ...
            Alternatively, this value can be computed by solving the same equation system for \FCA/ as described above, where the value to the firm is the funding  cost adjusted market value:
            \begin{equation}
                V = \pi(Y_C) + \FVA/ = \pi(Y_C) + \FCA/
                \label{eqn:no-funding-buyback-derivative-adjusted-value}
            \end{equation}
            while ensuring that $\Delta \pi(S) = 0$.
            ...
            and as before the donation needed from the counterparty to make the project a zero net present value for the shareholders is $\FCA/ = \num{0.2145446}$.
\end{document}