...
\begin{document}
    ...
    \label{sec:example-funding-benefit}
        ...
        \subsubsection{Debt retiring}
            ...
            with a credit value adjusted present value of 0.96. 
        ...
        \subsubsection{No funding buyback}
            ...
            The reduction can be explained by the projects payoff structure,
            as the states where the firm's asset value is the highest is
            also the states where the project's payoff are the highest and vice versa. 
            Therefore, by selling the project, the firm has reduced its riskiness
            and therefore the loss rate and credit spread of the creditors.
