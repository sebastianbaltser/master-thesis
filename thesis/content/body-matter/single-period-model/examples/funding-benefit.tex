...
\begin{document}
    ...
    \label{sec:example-funding-benefit}
        ...
        \subsubsection{Retiring Legacy Debt}
            ...
            On top of this, the amount can be recognised 
        ...
        \subsection{No Funding Buyback}
            ...
            \begin{figure}[t]
                ...
                \resizebox{\textwidth}{!}{%
                    \begin{tikzpicture}
                        \import{\graphicsfolder/numerical-examples/}{no-funding-buyback.tex}
                    \end{tikzpicture}
                }
            ...
            Hence, this is a negative net present value investment for the shareholders 
            and a positive net present value investment for the creditors.
            \\
            ...
            and the donation needed from the counterparty to make the project of zero net present value for the shareholders is $\FVA/ = \num{0.2145446}$.
