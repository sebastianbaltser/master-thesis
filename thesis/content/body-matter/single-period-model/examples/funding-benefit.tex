...
\begin{document}
    ...
    \label{sec:example-funding-benefit}
        ...
        \subsubsection{Equity buyback}
            ...
            This section studies the beneficial impacts on the firm's shareholders by doing this activity.
            ...
            Buying back equity from shareholders leaves two payoffs that must be added together:
            ...
            the marginal valuation expression by equity funding, \cref{eqn:marginal-shareholder-value-equity-financing}, is used.
            The payoff function for the firm is here the negative derivative payable,
            as the premium of the derivative serves as funding benefit.
            The change of wealth for the shareholders is then given by:
            \begin{equation}
                G_{\text{equity}} =
                p^{\mathbb{Q}}
                    \pi
