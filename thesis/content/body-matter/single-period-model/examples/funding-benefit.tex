...
\begin{document}
    ...
    \label{sec:example-funding-benefit}
        ...
        \subsubsection{Debt retiring}
            ...
            Notice that when the cash raised by selling the OTC bond contract 
            ...
            The cash flow following the bond contract can be viewed as newly issued debt
            ...
            Since the bond contract is a zero net present value for the firm, 
            ...
            the firm now enters a bond contract by selling a project to a counterparty
            with a credit value adjusted present value of \num{0.96}. 
            The bond premium is priced with no discount 
            and is immediately spent on retiring debt from its already existing creditors. 
            The bond payable is now a liability to the firm, ranking pari passu with the existing debt, 
            which before the bond contract had a face value of 80. 
            For simplicity, it is assumed, as in \cref{sec:risk-free-project},
            that the bond payable is known with certainty, hence it's a risk-free project. 
            The firm's balance sheet isn't affected by the transaction. 
            The change happens on the liability side, where the debt is partly swapped with a bond payable.\\
            ...
            the shareholders receive a payoff at time 1 equal to the pre-bond value.
