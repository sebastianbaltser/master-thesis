...
\begin{document}
    ...
    \label{sec:example-funding-benefit}
        ...
        \subsubsection{No funding buyback}
            ...
            the firm spends the cash proceeds from the upfront price in risk-free assets. 
            If the bond traded with the counterparty has a known payoff at time 1, this procedure is virtually the same as if the firm borrows money to buy the risk-free asset 
            as described in \cref{sec:example-risk-free-project-debt-issuance}. 
            To deviate from the exact same conclusions, the bond is now assumed to have a payoff structure at time 1 
            as described in \cref{tbl:risky-option-payoff}. 
            The bond will still be fairly priced, i.e. the price is the discounted expected payoff for the counterparty. 
            The credit risk still needs to be accounted for in the price. 
            At time 1 the firm will pay the counterparty accordingly, hence the bond payable, $Y_C$, 
            ...
            This implies that the firm's total asset value increases with an amount equal to the discounted upfront price. 
            The capital structure, after this transaction, is described in \cref{tbl:example-no-funding-buyback}, 
            where the bond theoretical fair value price and loss rate are found
            ...
            \end{align}
            with \cref{eqn:no-funding-buyback-default-state} making sure that the creditors and bond payable
            ...
            The market value of the bond including adjustments for credit risk would deem a fair price of the project,
            ...
            makes an argument for a valuation adjustment of the bond.
            Selling a bond and using the sales proceeds for buying the risk-free asset,
            is equivalent, but with opposite signs,
            to buying a bond and funding the upfront price with existing cash.
            ...
            Due to the risk in the bond, the shareholders do have a chance to gain from the project, 
            where in state $\omega_4$, the bond payable is less than the return on the risk-free asset.
            ...
            As the firm is funding the risk-free project with the premium proceeds, no funding benefits actually occur, and the \FVA/ is constituted entirely by the funding costs from paying the bond payable, i.e. the \FCA/.
            \\
            ...
            The adjusted bond value to the firm, \cref{eqn:no-funding-buyback-derivative-adjusted-value},
