...
\begin{document}
    ...
    \label{sec:example-funding-benefit}
        ...
        \subsubsection{No funding buyback}
            ...
            If the bond traded with the counterparty has a known payoff at time 1, this procedure is virtually the same as if the firm borrows money to buy the riskless asset 
            ...
            where in state $\omega_4$, the bond payable is less than the return on the riskless asset.
