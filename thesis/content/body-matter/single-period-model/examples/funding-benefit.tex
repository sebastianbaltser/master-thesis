...
\begin{document}
    ...
    \label{sec:example-funding-benefit}
        ...
        \subsubsection{Equity buyback}
            ...
            the bond value now adds to the aggregate liabilities of the firm, 
            ...
            leaving a smaller amount to the creditors compared to the pre-bond capital structure, 
            ...
            The loss rate increases from the pre-bond value and is computed as:
            ...
            As the price of the bond is assumed to be the credit risk adjusted market value,
