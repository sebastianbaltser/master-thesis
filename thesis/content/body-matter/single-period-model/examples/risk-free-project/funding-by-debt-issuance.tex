...
\begin{document}
    \subsubsection{Funding by debt issuance}\label{sec:example-risk-free-project-debt-issuance}
        ...
        \begin{equation}
            ...
            \pct{0.031201}
        \end{equation}
        Recall that the limiting spread, i.e. the expected post-project credit spread, 
        was calculated to $S = \pct{0.031566}$.
        If the limiting spread had been used for quantifying the funding costs,
        their size would therefore had been overestimated 
        and the value of the project would have been adjusted to much.
        The reason for the overestimation is that the project is safer than the firm's assets.
        The project is risk-free and therefore it reduces the riskiness of the firm,
        the loss rate, and the credit spread.
        Having, established and accounted for this,
        the example can continue with the \textit{actual} credit spread of \pct{0.031201},
        to get the correct results.
        Thus, the examples avoids the estimation, 
