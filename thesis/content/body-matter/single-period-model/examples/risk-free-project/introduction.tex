...
\begin{document}
    ...
    and the following associated Arrow-Debreu prices:
        ...
        \end{table}
    implying a discount factor of $\discountfactor = 0.99$ and a risk free interest rate of $r_{f} = 1.0101\%$.
    ...
    are discounted expected value of the payoff with respect to the risk neutral probability measure:
        \begin{gather}
            \pi(A) = \discountfactor \mathbb{E}^{\mathbb{Q}}\left[A\right] = 96.40 \\
            \pi(D) = \discountfactor \mathbb{E}^{\mathbb{Q}}\left[D\right] = 76.80
            \qquad \pi(S) = \discountfactor \mathbb{E}^{\mathbb{Q}}\left[S\right] = 19.60
        \end{gather}
