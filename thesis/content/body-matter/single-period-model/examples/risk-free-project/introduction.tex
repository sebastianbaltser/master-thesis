...
\begin{document}
    ...
    and that the project has a promised return of $1$ at time 1.
    The project is risk-free in the sense that the payoff is known with certainty at time 0, so:
        \begin{table}[H]
            ...
            \begin{tabular}{l|rrrrr}
                $i$ & 1 & 2 & 3 & 4 & 5 \\
                \hline
                $Y(\omega_{i})$ & $1$ & $1$ & $1$ & $1$ & $1$
            \end{tabular}
            \caption{}
        \end{table}
    which implies a present value of $\pi(Y) = \discountfactor \mathbb{E}^{\rnmeasure}\left[Y\right] = 0.99$, 
