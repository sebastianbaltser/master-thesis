...
\begin{document}
    ...
    The project is risk-free in the sense that the payoff is known with certainty at time 0.
        \begin{table}[H]
            \centering
        ...
        \end{table}
    Obtaining the project requires an upfront cost equal to the expected discounted value of the project.
