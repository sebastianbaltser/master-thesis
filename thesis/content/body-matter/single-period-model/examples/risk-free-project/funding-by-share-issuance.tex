...
\begin{document}
    ...
    \label{sec:example-equity-issuance}
        ...
        The random variables denoting the shareholders' payoffs are therefore given by:
            ...
            \end{align*}
        \indent
        After the transaction, the firm's balance sheet has increased with an amount equal to the upfront price. 
        The firm has a new asset on the asset side, the project receivable worth $\num{0.989994}$, 
        ...
        since the project is a zero net present value investment for the counterparty.
        ...
        their wealth increases by:
        \begin{equation*}\label{eqn:wealth-transfer-equality}
            -G_{\text{equity}} = \num{76.92} - \num{76.80} = \num{0.120001}
        \end{equation*}
        The value of the debt increases, 
        since the creditors get the entire project receivable in the default state. 
        ...
        \cref{eqn:shareholders-breakeven-equity-financing}:
            \begin{equation*}
                ...
                =
                    \num{0.869999}
            \end{equation*}
        and the adjustment needed is then: 
        \begin{equation*}
        ...
        This happens because the donation from the counterparty does not affect the total asset value of the firm.
        ...
        therefore, that share is not earned by the shareholders.
