...
\begin{document}
    \subsubsection{Funding by share issuance}
        ...
        While the payoff of the legacy creditors, with a face value of $L = \num{80}$, 
        ...
        To get the shareholders on board would would require a donation by the counterparty, 
        ...
        the marginal value for creditors and shareholder for different upfront prices.
