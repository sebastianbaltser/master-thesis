    ...
    \subsubsection{Funding by debt issuance}
        ...
        The marginal increase in the value of the firms equity per unit investment is therefore:
            ...
            \intertext{
                ...
                and the function's result when the firm does not default.
        ...
        the algebraic limit theorem ensures that limit of the summation operation,
        ...
        Deriving the limit of the first addend:
            ...
            \intertext{
                ...
                The limit of $\mathcal{D}^{c}$ is $D^{c}$,
