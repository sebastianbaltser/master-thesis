...
\begin{document}
    \subsubsection{Funding by debt issuance}
        ...
        approaches zero as $q$ approaches zero.
        ...
        The pre-project default event is constant in $q$, and its derivative is zero. 
        For an infinitesimal investment the post-project default indicator, 
        ...
        the derivative of the post-project default event
