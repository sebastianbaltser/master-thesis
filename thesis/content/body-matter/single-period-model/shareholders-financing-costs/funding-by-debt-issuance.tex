...
\begin{document}
    \subsubsection{Funding by Debt Issuance}
        ...
        as well as being independent of the quantity $q$. 
        ...
        specifically, $U(q)(\grossrfrate + s(q))$. 
        ...
        Both max-functions can therefore be replaced by using indicators for the default events:
            ...
            \end{align}
        Using the algebraic limit theorem and deriving the limit of the first addend in the numerator:
            \begin{align}
                &\quad
                \lim_{q\rightarrow 0}
                \discountfactor
            ...
            \end{align}
        \indent
        Turning to the limit of the second term in the numerator of \cref{eqn:G-debt-step-1}.
