...
\begin{document}
    \subsubsection{A pecking order of funding preferences}
        ...
        Since $(L-\kappa A) / L \leq 1$ the following holds:
            ...
            \end{align}
        Returning to \cref{eqn:G-debt-vs-G-equity-step-1} and substituting the expression fpr $S$:
            \begin{align}
                G_{\text{debt}}
                -
                G_{\text{equity}}
        ...
        which, combined with \cref{G-debt-vs-G-equity-inequality-1}, ensures that:
            ...
            \end{equation}
        Hence, shareholders' prefer debt funding over equity funding in terms of their value lost.
