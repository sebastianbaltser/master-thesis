...
\begin{document}
    \subsection{Funding Benefits}
        ...
        \subsubsection{Debt retiring}
            ...
            Similarly, the credit spread remains the same as the pre-project value: $s(q)=79/75.84-r_{f}-1=3.157\%$.
        ...
        \subsubsection{Equity buyback}
            ...
            Similarly, the credit spread increases from the pre-project value of 3.157\%: $s(q) = 80/76.711 - r_f - 1 = 3.28\%$.
            \begin{table}[H]
                \centering
                \begin{tabular}{l|rrrrr||r}
                    $i$ & 1 & 2 & 3 & 4 & 5 & Present value \\
