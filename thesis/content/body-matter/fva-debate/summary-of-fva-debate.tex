...
\begin{document}
    \subsection{Summary of the \FVA/ Debate}
        ...
        This summary is paraphrased in the the following sections where the arguments of different parties are presented,
        ...
        \subsubsection{\FVA/ according to theoreticians}
            Theoreticians, like Hull \& White themselves, 
            argue that finance theory requires the discount rate for a project to be determined by the risk of the project.
            ...
            However, the project is trading at a discount compared to the theoretical price,
            ...
            Furthermore, as the firm's average excess funding cost exceeds the excess yield of the project, 
            the average riskiness of the firm's existing projects exceeds the riskiness of the new project.
            ...
            Obtaining the project is a positive NPV investment, 
            so surely the firm should be able to find some distribution of the value to the stakeholders, 
            such that obtaining the project is a positive NPV for all entities.
            ...
            the financing cost of the firm will usually only gradually update to reflect change in riskiness.
