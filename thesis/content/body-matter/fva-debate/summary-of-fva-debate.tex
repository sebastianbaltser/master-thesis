...
\begin{document}
    \subsection{Summary of the FVA Debate}
        ...
        \subsubsection{FVA according to theoreticians}
            ...
            It is common for dealers to buy government bonds, such as Treasury Bills,
            and generally other low-yielding assets.
            For credit risky institutions these highly secure assets 
            are going to yield less than the dealers' average funding cost;
            nonetheless, dealers buy them without applying an \FVA/.
            ...
            why derivatives requires unsecured funding in the first place.
