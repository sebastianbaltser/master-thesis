...
\begin{document}
    ...
    \label{sec:funding-asymmetric-collateral}
        ...
        which it can pass on to its funding desk.
        ...
        since the excess collateral have reduced its financing needs elsewhere.
        ...
        However, when the hedge have stronger collateralization than the trade itself,
