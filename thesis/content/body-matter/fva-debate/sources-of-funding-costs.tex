...
\begin{document}
    ...
    \subsubsection{Funding costs from asymmetrical collateral agreements}
        ...
        To further grasp how unaligned collateralization schemes can lead
        to cash shortfalls or surpluses consider the example drawn by 
        \cref{fig:funding-costs-asymmetrical-csa}.
        ...
        The value of the firm's contract is drawn as a function of time by the blue line with dots.
