...
\begin{document}
    ...
    \subsection{Summary of the FVA Debate}
        ...
        The price of a derivative can be obtained by replicating the cashflows of the derivative with a self-financing trading strategy, 
    ...
    \subsection{Funding costs causing asymmetric valuations}
        ...
        and provide better cashflow management.
